...
const allTargets = [
    "21_C.jpg","11_C.jpg","13_C.jpg","14_C.jpg",
    "06_C.jpg","07_C.jpg","08_C.jpg","09_C.jpg",
    "12_C.jpg","15_C.jpg","16_C.jpg","21_S-top.jpg"
];

const target1Index = Math.floor(Math.random() * allTargets.length);
let target2Index = Math.floor(Math.random() * (allTargets.length - 1));
if (target2Index >= target1Index) target2Index++;

const target1ImageFile = allTargets[target1Index];
const target2ImageFile = allTargets[target2Index];
...
const allImages = [
    "21_C.jpg","11_C.jpg","13_C.jpg","14_C.jpg","21_S-top.jpg",
    "08_S-top.jpg","09_S-top.jpg","06_C.jpg","07_C.jpg","15_S-top.jpg",
    "07_S-top.jpg","06_S-top.jpg","12_S-top.jpg","08_C.jpg","09_C.jpg",
    "11_S-top.jpg","12_C.jpg","15_C.jpg","16_S-top.jpg","16_C.jpg",
    "14_S-top.jpg","13_S-top.jpg"
];
...
function buildTrialList(n) {
    let list = [];
    while (list.length < n) {
        list = list.concat(shuffle(allImages));
    }
    return list.slice(0, n);
}

const block1Images = buildTrialList(trialsPerBlock);
const block2Images = buildTrialList(trialsPerBlock);
